...
import { CategoryMap, Media, staticMedia, getImageURL } from "~/lib/media";
...
export const links: LinksFunction = () => {
  return [{
    rel: "stylesheet", href: "/css/pages/portfolio-item.css"
  }]
}
...
const Keymap = ({ object, className }: { object: Record<string, any>, className?: string }) => {
